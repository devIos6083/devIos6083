...
const developer = {
    ...
    education: "🎓 Ajou University - Industrial Engineering & AI Convergence",
    experience: {
        mobile: "Flutter (2+ years)",
        web: "TypeScript, Next.js, React",
        ai: "Python, RAG, Machine Learning"
    },
    languages: {
        programming: ["Dart", "Python", "TypeScript", "JavaScript"],
...
⚡ **Fun fact:** Ex-Navy IT Specialist 🚢 → Ski Resort Worker ⛷️ → Future Software Engineer 💻
...
➡️ [More blog posts...](https://velog.io/@devios6083)
...
⭐️ From [devIos6083](https://github.com/devIos6083) with ❤️
